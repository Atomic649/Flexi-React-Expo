...
const TotalSale = () => {
  ...
  return (
    <View className="flex flex-col pt-3 pb-2 px-2 items-center justify-center">
      <View className={`flex-row ${theme === "dark" ? "bg-zinc-800" : "bg-zinc-100"} items-center w-full h-60 rounded-2xl`}>
        ...
        {/* Total Sale */}
        <View className="bg-transparent items-center justify-center w-52 h-60 rounded-2xl">
          <Text className="text-sm text-zinc-500">
            Total Sale
          </Text>
          <Text className={`text-2xl font-bold ${useTextColorClass()}`}>
            999,999,999฿
          </Text>

          {/* row Ads and Profit */}
          <View className="flex-row justify-between w-full mt-2 px-6 ps-3">
            {/* ADS */}
            <View className="flex-colum">
              <Text className="text-sm text-zinc-500">
                Ads Cost
              </Text>
              <Text className="text-sm text-zinc-500 font-bold">
                999.99฿
              </Text>
            </View>
            ...
            <View className="flex-row justify-evenly w-full mt-3 px-0 ps-4">
            {/* %ADS */}
            <View className="flex-colum">
